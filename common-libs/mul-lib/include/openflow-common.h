/*
 *  openflow-common.h: Common openflow definitions that are common across
...
#define OFP_VERSION_11    0x02
#define OFP_VERSION_13    0x03
#define OFP_VERSION_131   0x04
#define OFP_VERSION_140   0x05
#define OFP_VERSION_MLAPI 0xff
#define OFP_MUL_SB_VERSION (OFP_VERSION)

#define OFP_MAX_TYPE ((1<<8)-1)
#define OFP_MAX_PAYLOAD (65536)
...
#define OFPXMT_OFB_MPLS_TC_SZ (1)
...
struct ofp_group_stats {
    ...
    uint32_t group_id; /* Group identifier. */
    uint32_t ref_count; /* Number of flows or groups that directly 
...
/* Body of reply to OFPMP_GROUP_FEATURES request. Group features. OF1.3+ */
...
/* Body of reply to OFPMP_METER request. Meter statistics-OF1.3+ */
...
/* Body of reply to OFPMP_METER_FEATURES request. Meter features. OF1.3+ */
