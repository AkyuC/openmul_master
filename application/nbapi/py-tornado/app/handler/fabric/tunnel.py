...
class TunnelHandler(BaseHandler):
    ...
    def get(self, tenant_id=None, network_id=None, tunnel_id=None):
        logger.debug("request url - %s", self.get_request_uri())
        logger.debug("request params - tenant_id: %s",tenant_id)
        self.write({"message":"get"})

    def options(self, tenant_id=None, network_id=None, tunnel_id=None):
        self.write("ok")

    def post(self, tenant_id=None, network_id=None, tunnel_id=None):
        logger.debug("request url - %s", self.get_request_uri())
        logger.debug("request params - tenant_id: %s",tenant_id)
        self.write({"message":"post"})

    def put(self, tenant_id=None, network_id=None, tunnel_id=None):
        self.write({"message":"post"})

    def delete(self, tenant_id=None, network_id=None, tunnel_id=None):
