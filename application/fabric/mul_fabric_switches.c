/**
 *  @file mul_fabric_switches.c
 *  @brief Mul fabric switch and port manager 
...
/**
 * @name fab_portid_hash_func -
 * 
 * @brief Hash  function for a port
 */
static unsigned int
...
/**
 * @name fab_portid_eq_func -
 * 
 * @brief Determine if two ports are equal
 */
static int
...
/**
 * @name fab_port_delete -
 *
 * @brief Delete a port to a switch
 */
int
...
/**
 * @name  fab_port_update -
 *
 * @brief Update flags of a port 
 */
void
 ...
 * @name fab_port_valid  -
 *
 * @brief Check if a port is valid on a switch 
 */
bool
...
/**
 * @name __fab_port_find  -
 *
 * @brief Get a port is valid on a switch 
 */
fab_port_t *
...
/**
 * @name fab_port_up  -
 * @brief Check if a port is up/running on a switch 
 *
 * @retval bool true if port is up else false
 */
bool
...
/**
 * @name fab_traverse_all_switch_ports - 
 *
 * @brief Loop through all switch ports and call iter_fn for each 
 */
static void
...
/**
 * @name fab_port_host_dead_marker_cmn -
 *
 */
static void
fab_port_host_dead_marker_cmn(fab_port_t *port, bool locked)
{
    ...
    if (port->host) {
        ...
        fab_host_delete(fab_ctx, &fl, host->tenant_id, host->network_id, 
                locked, true, false);
...
/**
 * @name fab_port_host_dead_marker -
 *
 * @brief Mark a host as dead whose port is not up or deleted 
 */
void
...
/**
 * @name __fab_port_host_dead_marker -
 *
 * @brief Mark a host as dead whose port is not up or deleted 
 */
static void
...
/**
 * @name fab_dpid_hash_func - 
 * @brief Hash function for datapath_id
 */
unsigned int
...
/**
 * @name fab_switch_put - 
 * @brief  Remove a reference to a switch 
 * @param switch : switch pointer 
 *
 */
void
...
/**
 * @name  fab_switch_put_locked - 
 * @brief Remove a reference to a switch while global lock is held
 * @param switch : switch pointer 
 *
 */
void
...
/**
 * @name fab_switch_get - 
 * @brief Get a reference to a switch 
 * @param fab_ctx : main ctx struct
 * @param dpid : datapath_id 
 *
 */
fab_switch_t *
...
/**
 * @name __fab_switch_get - 
 * @brief Get a reference to a switch (unlocked) 
 * @param fab_ctx : main ctx struct
 * @param dpid : datapath_id 
 *
 */
...
/**
 * @name __fab_switch_get_with_alias - 
 * @brief Get a reference to a switch using alias-id (unlocked)
 * @param fab_ctx : main ctx struct
...
/**
 * @name fab_switch_get_with_alias - 
 * @brief Get a reference to a switch using alias-id
 * @param fab_ctx : main ctx struct
 * @param alias : alias_id 
 *
 */
...
/**
 * @name __fab_switch_del_all_imap -
 *
 */
static void
...
/**
 * @name fab_traverse_all_switch -
 * @brief Loop through all switch and call iter_fn for each unlocked
 */
static void
...
/**
 * @name fab_switches_reset -
 * @brief Reset all the switches struct 
 */
void
...
/**
 * @name fab_switches_init -
 * @brief Initialize the switches struct
 */
int
